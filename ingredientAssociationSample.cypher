...
WHERE i <> j
WITH i.name AS ingredient1, j.name AS ingredient2, COUNT(DISTINCT r) AS noOfRecipes, totalNoOfRecipes, apoc.coll.sort(apoc.coll.toSet(COLLECT(r.name)))[..10] AS sampleRecipes
